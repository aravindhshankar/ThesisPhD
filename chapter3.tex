...
\begin{figure}[t]
    \centering
    \includegraphics[width=0.5\linewidth]{figures/chapter3/diffG.pdf} %figsize is actually one column
...
\begin{figure}
    ...
    \includegraphics[width=0.5\linewidth]{figures/chapter3/ratioFsv2.pdf} %figsize is actually one column
